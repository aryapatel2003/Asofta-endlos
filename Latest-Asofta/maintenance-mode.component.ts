...
export class MaintenanceModeComponent implements OnInit,OnDestroy {
  ...
  doOperation(plcRegisterType,registerAddress,registerOperation,resolve,resolveErrorId,errorName){
    console.log("hiii")
  ...
  doStopOperation(machineErrorTypeView : MachineErrorTypeView){
    ...
    machineErrorTypeView.errorTypeOperationModel.forEach((errorTypeOperationModel : MachineErrorTypeOperationView) => {
      this.doOperation(
